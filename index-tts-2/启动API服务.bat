...
echo [INFO] 启动 IndexTTS API Server...
echo [INFO] 访问 http://localhost:7860/docs 查看 API 文档
echo.

"%PYTHON_EXECUTABLE%" -m uvicorn api_server.main:app --host 0.0.0.0 --port 7860 --reload
