...
class TaskConfig:
    ...
    video_transition: TransitionEffect = TransitionEffect.NONE
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "video_transition": self.video_transition.value,
            "video_transition_duration": self.video_transition_duration,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TaskConfig":
        ...
        transition = data.get("video_transition", "none")
        config.video_transition = TransitionEffect(transition) if transition else TransitionEffect.NONE
        config.video_transition_duration = data.get("video_transition_duration", 0.5)
